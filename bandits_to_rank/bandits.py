...
class propos_uniform():
    ...
    def get_proposal(self):
        return [Proposal_Uniform(on_theta=True, k=i) for i in range(self.nb_arms)] + [
            Proposal_Uniform(on_theta=False, k=i) for i in range(1, self.nb_position)]
...
class TS_MH_kappa_desordonne:
    ...
    def choose_next_arm(self):
        ...
        thetas = samples[-1][0]
        kappas = samples[-1][1]
        if self.proposal_method.turn % 1000 == 0:
            print(thetas, kappas)
