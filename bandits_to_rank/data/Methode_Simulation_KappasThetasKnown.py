...
#### Simulation de log a partir de theta et de kappa
...
### Mise en forme des performances (matrice des succes/fail suivant les positions et les produits)
...
### Renvoie la places ou l'item a été le plus placé
...
### Renvoie la produit qui a été le plus placé a une position
