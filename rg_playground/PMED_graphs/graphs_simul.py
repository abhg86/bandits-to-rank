...
# %%
resdir = "../../Test/exp_AAAI2021/results/simul/"

refs = {}
for env_name in ["std", "big", "xxsmall"]:
    refs[env_name] = {}
    refs[env_name]["random"] = retrieve_data_from_zip(resdir + 'purely_simulated__' + env_name + '__Bandit_EGreedy_SVD_1e+20_c_1_maj__games_100000_nb_trials_1000_record_length_20_games.gz')

    #refs[env_name]["PMED 0.01, 10, 10000"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_0.01_alpha_10_gap_MLE_10000_gap_q__games_100000_nb_trials_1000_record_length_3_games.gz')
    refs[env_name]["PMED 1.0, 10, 10000"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_10_gap_MLE_10000_gap_q__games_100000_nb_trials_1000_record_length_10_games.gz')
    #refs[env_name]["PMED 100., 10, 10000"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_100.0_alpha_10_gap_MLE_10000_gap_q__games_100000_nb_trials_1000_record_length_1_games.gz')

    refs[env_name]["PMED 0.01, 10, 1000"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_0.01_alpha_10_gap_MLE_1000_gap_q__games_100000_nb_trials_1000_record_length_20_games.gz')
    #refs[env_name]["PMED 0.01, 10, 1000 bis"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_0.01_alpha_10_gap_MLE_1000_gap_q__games_10000_nb_trials_1000_record_length_20_games.gz')
    refs[env_name]["PMED 1.0, 10, 1000"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_10_gap_MLE_1000_gap_q__games_100000_nb_trials_1000_record_length_20_games.gz')
    #refs[env_name]["PMED 1.0, 10, 1000 bis"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_10_gap_MLE_1000_gap_q__games_10000_nb_trials_1000_record_length_20_games.gz')
    #refs[env_name]["PMED 1.0, 10, 1000 ter"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_10_gap_MLE_1000_gap_q__games_10000_nb_trials_1000_record_length_20_games_bis.gz')
    #refs[env_name]["PMED 1.0, 10, 1000 qua"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_10_gap_MLE_1000_gap_q__games_10000_nb_trials_1000_record_length_20_games_ter.gz')
    refs[env_name]["PMED 100., 10, 1000"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_100.0_alpha_10_gap_MLE_1000_gap_q__games_10000_nb_trials_1000_record_length_20_games.gz')

    #refs[env_name]["PMED 1.0, 10, 100"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_10_gap_MLE_100_gap_q__games_10000_nb_trials_1000_record_length_20_games.gz')
    refs[env_name]["PMED 1.0, 1, 100"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_100_gap_q__games_100000_nb_trials_1000_record_length_15_games.gz')
    #refs[env_name]["PMED 1.0, 1, 100 bis"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_100_gap_q__games_10000_nb_trials_1000_record_length_20_games.gz')
    refs[env_name]["PMED 1.0, 1, 10"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_10_gap_q__games_10000_nb_trials_1000_record_length_12_games.gz')
    #refs[env_name]["PMED 1.0, 1, 10 bis"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_10_gap_q__games_2000_nb_trials_1000_record_length_20_games.gz')
    refs[env_name]["PMED old 1.0, 1, 0"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_0_gap_q__games_100000_nb_trials_1000_record_length_20_games_old.gz')
    refs[env_name]["PMED 1.0, 1, 0"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_0_gap_q__games_100000_nb_trials_1000_record_length_20_games.gz')
    refs[env_name]["PMED bis 1.0, 1, 0"] = retrieve_data_from_zip(resdir + f'purely_simulated__{env_name}__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_0_gap_q__games_50000_nb_trials_1000_record_length_5_games.gz')
