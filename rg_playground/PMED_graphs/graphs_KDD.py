...
# %%
resdir = "../../Test/exp_AAAI2021/results/real_KDD/"
...
refs["PMED old 1.0, 1, 0"] = retrieve_data_from_zip(resdir + f'KDD_all__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_0_gap_q__games_100000_nb_trials_1000_record_length_133_games.gz')

refs["PMED0 1.0, 1, 0"] = retrieve_data_from_zip(resdir + f'KDD_0_query__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_0_gap_q__games_10000_nb_trials_1000_record_length_16_games.gz')

refs["PMED 1.0, 1, 0"] = retrieve_data_from_zip(resdir + f'KDD_all__sorted_kappa__Bandit_PMED_1.0_alpha_1_gap_MLE_0_gap_q__games_100000_nb_trials_1000_record_length_160_games.gz')
...
trials = [10**5, 5*10**5, 10**6, 2*10**6, 4*10**6, 8*10**6, 10**7]
mu = [200, 700, 1200, 1800, 2600, 4600, 5800]
plt.plot(trials, mu, color = f'C{i%10}', linestyle = ':', label="PMED paper")    
...
print(time_sec_to_HMS(np.array(refs["PMED 1.0, 1, 0"].record_results['time_to_play'])[:,-1].mean()))
print(time_sec_to_HMS(np.array(refs["PMED 1.0, 1, 0"].record_results['time_to_play'])[:,-1].mean()*10))
print(np.array(refs["PMED 1.0, 1, 0"].record_results['time_to_play'])[:,-1].mean()*10/10**7)
