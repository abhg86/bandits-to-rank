...
for env_name in ["std", "xxsmall", "big"]: 
    ...
    refs[env_name][f'TopRank_TH_doubling, semi-oracle'] = retrieve_data_from_zip(f'./results/purely_simulated__{env_name}__extended_kappas__Bandit_TopRank_oracle_50.0_delta_TimeHorizonKnown_doubling_trick__games_100000_nb_trials_1000_record_length_20_games.gz')
    refs[env_name][f'TopRank_TH_doubling, sorted'] = retrieve_data_from_zip(f'./results/purely_simulated__{env_name}__extended_kappas__sorted_kappa__Bandit_TopRank_oracle_50.0_delta_TimeHorizonKnown_doubling_trick__games_100000_nb_trials_1000_record_length_20_games.gz')
...
for env_name in ["std", "xxsmall", "big"]:
    ...
    #    plt.xlim([1000, 20000000])
    #    plt.ylim([70,200000])
    plt.savefig("./results/graph/" + env_name + "__TopRank_20g_10000000t.pdf", bbox_inches = 'tight',
        pad_inches = 0)
...
for env_name in ["std", "xxsmall", "big"]:
    ...
    #    plt.xlim([1000, 20000000])
    #    plt.ylim([70,200000])
    plt.savefig("./results/graph/" + env_name + "__PBM_PIE_20g_100000t.pdf", bbox_inches = 'tight',
        pad_inches = 0)
    ...
    plt.loglog()
    #plt.xscale('log')
    plt.savefig("./results/graph/" + env_name + "__PBM_UCB_20g_100000t.pdf", bbox_inches = 'tight',
        pad_inches = 0)
...
for env_name in ["std", "xxsmall", "big"]:
    ...
    if env_name == "xxsmall":
        ...
        plt.xlim([10, 100000])
        plt.ylim([3, 50000])
    plt.savefig("./results/graph/" + env_name + "__PBM-HB_20g_100000t_tunec.pdf", bbox_inches='tight',
                pad_inches=0)
