...
class ParamContainer(object):
    ...
    def get(self, *args):
        """
        Returns a click model parameter that corresponds to given index.
        NOTE: The names and semantics of the index must be specified by a subclass!
    ...
    def set(self, param, *args):
        """
        Sets the given parameter according to given index.
        NOTE: The names and semantics of the index must be specified by a subclass!
        """
        pass
