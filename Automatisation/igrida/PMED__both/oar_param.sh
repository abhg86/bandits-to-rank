...
#OAR -l gpu_device=1,core=1,walltime=01:0:00
...
#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/PMED__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/PMED__both.%jobid%.output
