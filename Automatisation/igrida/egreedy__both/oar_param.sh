...
#OAR -O /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/egreedy__both__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/egreedy__both__both.%jobid%.output
