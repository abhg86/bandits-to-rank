...
#OAR --name=PBM_TS__both

#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/PBM_TS__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/PBM_TS__both.%jobid%.output
