...
#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/PBM_UCB__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/PBM_UCB__both.%jobid%.output
