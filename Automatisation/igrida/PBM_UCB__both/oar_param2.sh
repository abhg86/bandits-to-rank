...
#OAR -l {mem_core < 1024}/nodes=1/core=1,walltime=10:05:00
EXECUTABLE="python3 $HOME/src/bandits-to-rank/Automatisation/igrida/exp.py"
#OAR --array-param-file ./python_param2.txt
export SCRATCHDIR="/temp_dd/igrida-fs1/cgauthie/SCRATCH"
#OAR --name=PBM_UCB__both

#OAR -O /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/PBM_UCB__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/PBM_UCB__both.%jobid%.error
