...
#OAR -l {mem_core < 1024}/nodes=1/core=1,walltime=5:00:00
EXECUTABLE="python3 $HOME/src/bandits-to-rank/Automatisation/igrida/exp.py"
#OAR --array-param-file ./python_param_0001_Noracle_.txt
export SCRATCHDIR="/temp_dd/igrida-fs1/cgauthie/SCRATCH"
#OAR --name=PBM_PIE__both_0001_Noracle

#OAR -O /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/PBM_PIE__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/PBM_PIE__both.%jobid%.error
