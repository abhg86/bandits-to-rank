...
#OAR --name=BubbleRank__both

#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/BubbleRank__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/BubbleRank__both.%jobid%.output
