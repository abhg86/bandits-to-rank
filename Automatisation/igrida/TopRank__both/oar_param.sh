...
#OAR --array-param-file ./python_param_equi.txt
export SCRATCHDIR="/srv/tempdd/cgauthie/SCRATCH"
#OAR --name=TopRank_equi

#OAR -O /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/TopRank__equi.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/TopRank__equi.%jobid%.error
