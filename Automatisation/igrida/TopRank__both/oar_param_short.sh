...
#OAR --name=TopRank__both

#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/TopRank__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/TopRank__both.%jobid%.output
