...
#OAR -p cluster = 'bermuda'
#OAR -p cluster = 'bermuda'
# 8 processors
#model name      : Intel(R) Xeon(R) CPU           E5640  @ 2.67GHz
#cache size      : 12288 KB
# MemTotal:       49552396 kB
export SCRATCHDIR="/temp_dd/igrida-fs1/rgaudel/SCRATCH"
#OAR --name=computation_time

#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/computation_time.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/computation_time.%jobid%.output
