...
#OAR --name=PB_MHB__both

#OAR -O /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/PB_MHB__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/PB_MHB__both.%jobid%.output
