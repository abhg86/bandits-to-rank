...
#OAR --name=BC_MPTS__both

#OAR -O /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/BC_MPTS__both.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/rgaudel/SCRATCH/outputs/BC_MPTS__both.%jobid%.output
