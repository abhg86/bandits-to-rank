...
#OAR -l core=1,walltime=1:30:00
EXECUTABLE="python3 $HOME/src/bandits-to-rank/Automatisation/igrida/playgame_egreedy_KDD.py"
#OAR --array-param-file ./python_param_BC.txt
SCRATCHDIR=/temp_dd/igrida-fs1/cgauthie/SCRATCH
#OAR --name=TSMH_preliminaries_simul/

#OAR -O /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/TSMH_preliminaries_simul.%jobid%.output
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/TSMH_preliminaries_simul.%jobid%.error
