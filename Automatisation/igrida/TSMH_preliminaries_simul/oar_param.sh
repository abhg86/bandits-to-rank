...
#OAR -l core=1,walltime=3:00:00
EXECUTABLE="python3 $HOME/bandits-to-rank/Automatisation/igrida/playgame_egreedy_KDD.py"
...
#OAR -E /temp_dd/igrida-fs1/cgauthie/SCRATCH/outputs/TSMH_preliminaries_simul.%jobid%.output
