...
# --- prepare data ---
kappas = sorted([0.3, 0.55, 0.7, 0.5, 0.35, 0.2, 0.45, 0.9, 0.85, 0.6, 0.75, 0.8, 0.65, 0.4, 0.25]) #[0.7, 0.5, 0.9, 0.6, 0.8] #[0.5, 0.4, 0.6, 0.45, 0.55] #[0.5, 0.1, 0.9, 0.3, 0.7]
thetas = sorted([0.55, 0.4, 0.7, 0.3, 0.65, 0.1, 0.85, 0.5, 0.15, 0.8, 0.45, 0.6, 0.35, 0.2, 0.75]) #[0.7, 0.9, 0.5, 0.8, 0.6] #[0.2, 0.3, 0.1, 0.25, 0.15] #[0.5, 0.9, 0.1, 0.7, 0.3]
...
player = OSUB_PBM(nb_prop, nb_trials, nb_positions)
